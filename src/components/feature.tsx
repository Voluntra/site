...
const Feature = ({ description, icon, title }: FeatureProps) => {
  return (
    <div className="select-none p-5 flex flex-col aspect-square backdrop-blur-md bg-neutral-900 border border-neutral-800 rounded-md sm:hover:border-neutral-600 ease-in duration-200 transition-all">
      <div>
